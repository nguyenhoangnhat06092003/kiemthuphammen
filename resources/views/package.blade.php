    ...
    <div id="pricing" class="section overlay">
        <div class="container-fluid">
            <div class="section-title text-center">
                ...
                <p>Sorae Restaurant luôn có các gói ưu đãi của từng dịch vụ, sẵn sàng đáp ứng nhu cầu của bạn </p>
            </div><!-- end title -->
                    ...
                    <div class="form-row">
                        <div class="form-group row col-12">
                            <label for="organizationDate"
                                ...
                                gian</label>
                            <input type="datetime-local" class="inp form-control col-12" id="checkday" onchange="checkDate()" placeholder="Ngày/giờ"
                        ...
                        <div class="form-group row my-col col-12">
                            <label style="font-size: 1.2em; color: rgb(112, 112, 112); font-weight: 400"
                                ...
                                lượng
                                người</label>
                            <input type="number"  min="1" onkeypress="return event.charCode >= 48" class="inp form-control col-12" id="peopleNumber" name="peopleNumber">
                        </div>
...
@section('script')
    ...
    <script>
        $(document).on('ready', function() {
            ...
            document.getElementsByName("organizationDate")[0].min = today;
        });
        ...
        $(function() {
            ...
            $('#categoryOption').on("change", function(e) {
                ...
                $.ajax({
                    // url: "http://localhost/Sorae/search",
                    url: "{{ route('search') }}",
                    method: "POST", // phương thức gửi dữ liệu.
                    data: {
                        foodName: foodName,
            ...
            $(".create-menu").on("click", function() {
                var _token = $('input[name="_token"]').val();
                $.ajax({
                    // url: "http://localhost/Sorae/init-session",
            ...
            $("#btnUpdateMenu").on("click", function() {
                var _token = $('input[name="_token"]').val();
                $.ajax({
                    // url: "http://localhost/Sorae/update-menu",
