...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light m-0 p-4" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{route('home')}}"><span class="flaticon-pizza-1 mr-1"></span>Sorae Japanese <br><small>Restaurant</small></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="{{ url('about') }}" class="nav-link">Về SORAE</a></li>
                @guest
                    <li class="nav-item">
