    ...
    <div class="right_col" role="main" style="min-height: 1000px">
      <div class="col-12">
        ...
        <ul class="nav nav-tabs nav-tab tabs d-flex text-center col-12" style="background: #eaeaea"> 
            <li class="tab-item active col-4"><a data-toggle="tab" href="#tab-9-3" data-case="HDLocal">Đơn hàng chờ duyệt</a></li>
            <li class="tab-item col-4"><a data-toggle="tab" href="#tab-9-1" data-case="HDPassenger">Đơn hàng đã duyệt</a></li>
            <li class="tab-item col-4"><a data-toggle="tab" href="#tab-9-1" data-case="HDPay">Đơn hàng đã thanh toán</a></li>
            <div class="line"></div>
        </ul>
      </div>
                                ...
                                @foreach ($approvedOrders as $approvedOrder)
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last">
                                          ...
                                          >Xem chi tiết</button> --}}
                                          <a class="btn btn-warning" href="{{URL::to('/admin/confirmPay/'.$approvedOrder->id)}}">Thanh toán</a>
                        ...
                        <table class="table table-striped jambo_table bulk_action" >
                            ...
                            <tbody class="text-center" style="font-size: 16px">
                                ...
                                @foreach ($approvedPays as $approvedPay)
                                    <tr class="even pointer">
                                        <td class="align-items-center ">{{ ++$i3 }}</td>
                                        <td class="align-items-center ">{{ $approvedPay->users->fullName }}</td>
                                        <td class="align-items-center ">{{ $approvedPay->services->name }}</td>
                                        <td class="align-items-center ">{{ $approvedPay->created_at }}</td>
                                        <td class="align-items-center ">{{ $approvedPay->order_status->name }}</td>
                                        <td class=" last">
                                          {{-- <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalViewDetailOrder"
                                          >Xem chi tiết</button> --}}
                                          <a class="btn btn-warning" href="{{URL::to('/admin/printInvoice/'.$approvedPay->id)}}">In hóa đơn</a>
